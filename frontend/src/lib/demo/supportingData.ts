/**
 * Supporting demo data for the non-Deal-Room pages.
 * All synthetic — paper prototype per Bain × Distyl onboarding.
 */
...
export const STAKEHOLDERS: Stakeholder[] = [
  {
    ...
    title: 'CPO · Devices & Hardware',
    side: 'internal',
    org: 'T-Mobile',
    influence: 'high',
    notes: 'Approves counter-offers above $5M variance. Prefers dollar-impact framing over technical narrative.',
    tags: ['approver', 'q1-cycle'],
  },
  {
    id: 'lead-advisor',
    name: 'Lead External Advisor',
    title: 'Partner',
    side: 'partner',
    org: 'Advisory',
    influence: 'high',
    notes: 'Lead external advisor on Q1 cycle. Drafting the executive narrative for the counter-offer review.',
    tags: ['narrative-owner'],
  },
  {
    id: 'scope-advisor',
    name: 'Engagement Scope Partner',
    title: 'Partner',
    side: 'partner',
    org: 'Advisory',
    influence: 'medium',
    notes: 'Strategic scoping; approves engagement direction and use-case prioritization.',
    tags: ['strategic-scope'],
  },
  {
    id: 'waterfall-author',
    name: 'Procurement Planning Lead',
    title: 'Senior Manager',
    side: 'partner',
    org: 'Advisory',
    influence: 'medium',
    notes: 'Authored the P&L waterfall framework. Maintains lever assumptions.',
    tags: ['waterfall-author'],
  },
  {
    id: 'tara',
  ...
  },
  {
    ...
    name: 'External Research Validator',
    title: 'Director, Research',
    side: 'partner',
    org: 'Industry Research',
    influence: 'low',
    notes: 'Validating the 30% promo-waste hypothesis. Returning estimate before executive review.',
